...
export default function DetailPage({ params }) {
    ...
    const dispatch = useDispatch(); //dispatch được sử dụng để gửi (dispatch) các action đến Redux store để thay đổi trạng thái.
    const cart = useSelector((state) => state.cart);//useSelector: Đây là một hook từ react-redux dùng để truy cập trạng thái từ Redux store. 
    console.log(cart);
